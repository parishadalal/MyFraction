...
class PJ1_Test
{
    ...
    private static MyFraction readFraction() {
        System.out.print( "\nTry to read a fraction x/y, please enter x y : " );
        int numerator = scanner.nextInt();                            
        int denominator = scanner.nextInt();                          
        MyFraction f = new MyFraction(numerator, denominator);
	...
	System.out.println("  5) compareTo \t6) equals \t7) gcd \t\t8) toDouble \t9) setMyFraction ");  
	      ...
	      switch (op) {
			...
			System.out.println("\t" + n1 + " eq "+ n1 + " = " + n1.equals(n1));
		        ...
		        break;
             	case 7:  
                        ...
                        x = scanner.nextInt();
                        y = scanner.nextInt();
                        System.out.println("\t GCD of " + x +" and "+ y + " is " + n1.gcd(x,y)) ;
		        break;
            	case 8: 
			System.out.println("\t" + n1 + " toDouble = " + n1.toDouble());
                ...
                case 9:
                        ...
                        x = scanner.nextInt();
                        y = scanner.nextInt();
                        System.out.print("\t" + x +"/"+ y + " setMyFraction = ");
                        n1.setMyFraction(x,y);
                        System.out.println(n1);
                        break;
	      }

           } // end try                                                     
           catch ( MyFractionException fracitonException )                
           {                                                                
